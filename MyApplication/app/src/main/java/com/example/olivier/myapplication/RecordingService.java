...
public class RecordingService extends Service {
    ...
    public void setFileNameAndPath(){
        ...
        do{
            ...
            String mFormat = SettingsFragment.getFormat();
            String mName = SettingsFragment.getNamed();
            mFileName = mName + " #" + (mDatabase.getCount() + count) + mFormat;
    ...
    public void stopRecording() {
        mRecorder.stop();
        int mElapsedMillis = (int) (System.currentTimeMillis() - mStartingTimeMillis);
        mRecorder.release();
